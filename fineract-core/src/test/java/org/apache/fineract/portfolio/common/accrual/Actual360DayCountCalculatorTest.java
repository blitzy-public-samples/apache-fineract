...
/**
 * Unit tests for {@link Actual360DayCountCalculator} (Actual/360 convention) covering the six boundary cases (S1-S6) of
 * the committed Interest-Accrual Day-Count acceptance dataset. Each test drives the real production calculator and
 * asserts the expected accrued interest rounded HALF_UP to currency precision.
 */
class Actual360DayCountCalculatorTest {

    @Test
    void s1_baseOneMonthPeriod() {
        Actual360DayCountCalculator calculator = new Actual360DayCountCalculator();
        ...
        assertThat(accrued).isEqualByComparingTo(new BigDecimal("430.56"));
    }
    ...
    void s2_fullNonLeapYear() {
        ...
        assertThat(accrued).isEqualByComparingTo(new BigDecimal("5069.44"));
    }
    ...
    void s3_leapYearFebruary() {
        ...
        assertThat(accrued).isEqualByComparingTo(new BigDecimal("855.90"));
    }
    ...
    void s4_quarterCrossingA31stMonthEnd() {
        ...
        assertThat(accrued).isEqualByComparingTo(new BigDecimal("1236.11"));
    }
